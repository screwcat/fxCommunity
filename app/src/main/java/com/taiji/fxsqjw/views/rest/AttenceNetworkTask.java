...
import com.taiji.fxsqjw.views.adapter.AttenceScrollAdapter;
...
public class AttenceNetworkTask extends AsyncTask<String, Void, byte[]> {
    private Context context;
    private ProgressDialog pDialog;
    private List totalList = null;
    private AttenceScrollAdapter adapter = null;

    public AttenceNetworkTask(Context context, List totalList, AttenceScrollAdapter adapter){
