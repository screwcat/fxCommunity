...
public class SJCJAddressWriteNetworkTask extends AsyncTask<String, Void, byte[]> {
    private Context context;
    private ProgressDialog pDialog;
    private List totalList = null;
    private SJCJAddressWriteScrollAdapter adapter = null;

    public SJCJAddressWriteNetworkTask(Context context, List totalList, SJCJAddressWriteScrollAdapter adapter){
    ...
    private List<Map<String, String>> jsonToList(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String dzmc = jsonObject2.getString("dzmc");
                String mldzid=jsonObject2.getString("mldzid");
