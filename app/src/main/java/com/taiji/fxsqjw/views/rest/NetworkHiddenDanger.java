...
public class NetworkHiddenDanger extends AsyncTask<String, Void, byte[]> {
    private Context context;
    private ProgressDialog pDialog;
    private List totalList = null;
    private HiddenDangerAdapter adapter = null;

    public NetworkHiddenDanger(Context context, List totalList, HiddenDangerAdapter adapter) {
    ...
    protected void onPreExecute() {
        ...
        item.put("dangerId", "8642");
        item.put("dangerName", "邱旭");
        item.put("dangerTime", "2017-10-26 19:41");
        item.put("dangerSituation", "阜新市细河区人民大街58号翔宇一品小区14-23-4");
        item.put("dangerAddress", "辽宁省阜新市细河区人民大街");
        totalList.add(item);
    ...
    protected void onPostExecute(byte[] result) {
        ...
        if (result != null) {
            ...
            try {
                ...
                HashMap<String, String> item = new HashMap<String, String>();
                item.put("dangerId", "8642");
                item.put("dangerName", "张三");
                item.put("dangerTime", "2017-11-27 20:52");
                item.put("dangerSituation", "阜新市细河区人民大街58号翔宇一品小区14-23-2");
                item.put("dangerAddress", "辽宁省阜新市细河区人民大街");
                totalList.add(item);
                //totalList.addAll(list);
                adapter.notifyDataSetChanged();
